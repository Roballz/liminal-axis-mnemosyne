...
const BTN_ID = 'mnemosyne-topbar-button';
const STYLE_ID = 'mnemosyne-topbar-style';
...
/**
 * 往 ST 顶栏(#top-settings-holder)注入一个快速打开Mnemosyne的 drawer 按钮,
 * 位置在「用户设定管理」(#persona-management-button)左边。
 *
 * 注入的按钮**不进 shadow DOM**——直接用 ST 的 .drawer / .drawer-icon 类名,
 * 跟随酒馆主题美化。点击只负责打开Mnemosyne窗口,不展开任何抽屉(故无 .drawer-toggle,
