...
const BTN_ID = 'mnemosyne-qr-button';
const BAR_CLASS = 'mnemosyne-qr-bar'; // 仅当 #qr--bar 不存在时,我们自建的条加这个标记类,便于回收

/**
 * 往聊天框上方注入一个「Mnemosyne」按钮,外观与 ST 原生快速回复按钮**完全一致**。
 *
...
function buildButton(): HTMLElement {
  ...
  btn.title = '打开Mnemosyne';
  btn.textContent = 'Mnemosyne';
