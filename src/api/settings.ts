...
const SETTINGS_KEY = 'mnemosyne_daily';
const SHARED_CHANNELS_KEY = 'mnemosyne_api_channels';
...
const SHARED_EXCLUDES_KEY = 'mnemosyne_exclude_settings';
...
export function hydrateSettings(): void {
  ...
  const stored = ctx.extensionSettings[SETTINGS_KEY] ?? ctx.extensionSettings.baibai_book;
