// Synchronous SHA-256 for the synchronous contract oracle in Node and TT WebView.
// Fingerprint envelope/JCS stay in primitives.mjs; cross-checked against WebCrypto.
