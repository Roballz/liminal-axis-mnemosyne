...
更新并完整刷新后，打开受影响的原聊天，等待“已归档”，再检查事件页、待审核数量及历史摘要注入。仅由该误判造成的来源变化，会在正常归档时重新选中同一消息原有的 AI 来源版本，从而恢复通过校验的事件和高层摘要；不用取消隐藏、重建链、重新生成摘要或逐条“保留”。事件、概要、成员和摘要不重写，旧误判版本仍保留为历史。若仍有待审核项，重新加载只读差异；真正的正文、身份或下级摘要版本变化仍需分别处理，不能据第一处角色差异保证全数恢复。
