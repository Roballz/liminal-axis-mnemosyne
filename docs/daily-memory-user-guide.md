...
2. **加入已有链**：选链并确认，再选“立刻更新概要”或“不更新概要（仅入库）”。后者不调用模型。前者先确保本楼已入链，再发该链全部有效成员材料，覆盖更新当前概要、关键词，并追加本次新进展；已有本楼不会重复关联。全部成员已更新时不再花费一次请求。
...
折叠卡片显示标题、关键词、状态与关联数、最新进展；展开显示完整当前概要和“完整追加史”中的成员摘要。移除关联不删除原摘要，但相关旧概要/进展不再当作完整有效材料使用。
